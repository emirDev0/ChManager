function run(msg)
	...
	.."   _Block list:_\n"
	.."     `/blocklist`\n\n"
	.."   _Send message to all users:_\n"
	.."     `/sendtoall {message}`\n\n"
	.."   _All users list:_\n"
	.."     `/users`"
	about_txt = "*Sourcesiran Robot* v"..bot_version.."\n\n   _- Send Message by SMS_\n   _- Add, Edit & Remove Caption_\n   _- Send Inline Keyboard_\n   _- Remove Forward Info_\n   _- Send Bold,Italic and Cod Text_\n   _- Send Hyper Link_\n   _- Timer for Post to Next Time_\n   _- & More..._\n\n`Made in Sourcesiran Team and Powered by Sourcesiran Co. Group`"
	about_key = {{{text = "کانال رسمی" , url = "https://telegram.me/ssss3456"}},{{text = "ربات تیم" , url = "https://telegram.me/emirDevBot"}},{{text = "پیام رسان" , url = "https://telegram.me/Samyar3244_bot"}}}
  start_txt = "به ربات "..bot.first_name..' خوش آمدید\nاستفاده از این ربات برای 1ماه رایگان بوده و جهت فعال شدن اکانت به مدت یک ماه به بخش "درباره ما"مراجعه کرده و وارد ربات پیام رسان شوید و ایدی عددی خودتون و کانالی ک رباتو توش ادمین میکنید بفرستید تا اکانت شما را فعال کنیم و شما از ربات استفاده کنید.\n`بعداز 1ماه برای شارژ باید مبلغ 5تومان را برای استفاده مجدد پرداخت کنید .\nاز جمله قابلیات این ربات میتوان به موارد زیر اشاره کرد:\n-ارسال متن به کانال از طریق پیامک (اس ام اس)\n-ارسال کیبرد شیشه ای به کانال\n-افزودن، ویرایش و حذف درج نویس در فورواردها\n-حذف منبع فورواردها\n-ارسال زماندار پست\n-ارسال متون با استایل و فونت های مختلف\n-افزودن لینک به یک کلمه\n-و...`\n_Dev_: @Somerhaider\n_Channel_: @Sourcesiran'
...
`با استفاده از این کلید میتوانید نام کانال، یوزرنیم کانال، آی دی کانال، شماره ارتباطی با سامانه پیامکی، انقضای اکانت، آمار کانال، سازنده ی کانال، تعداد ادمینهای کانال، لیست ادمینهای کانال را در یک لیست ببینید.`]]
	...
	elseif msg.text == "مثال کیبرد اینلاین و مارک داون" then
		inlinekey = {{{text = "کانال تیم" , url = "https://telegram.me/ssss3456"}},{{text = "ربات تیم" , url = "https://telegram.me/emirDevBot"}}}
		text = "مثال استایل نویس با فونتهای مختلف:\n*Sourcesiran Team*\nSourcesiran Team\n_Sourcesiran Team_\n`Sourcesiran Team`\nتیم سورس ایران\n`تیم سورس ایران`\nمثال هایپر لینک:\n[تیم سورس ایران](telegram.me/Sourcesiran)\n[Sourcesiran Team](telegram.me/Sourcesiran)\nمثال کیبرد اینلاین:"
	...
	elseif msg.text:find('/edit') and msg.from.id == sudo_id then
		...
		if usertarget then
			...
			return send_msg(sudo_id, "*/edit 12345678,@Sourcesiran,9121234567*\n`/edit [telegram id],[@channel],[number]`", true)
		end
	...
	elseif msg.text == "مثال کیبرد اینلاین" then
		return send_inline(msg.from.id, "`تیتر کیبرد اینلاین با قابلیت استفاده از قابلیت مارک داون`", {{{text = "کانال تیم" , url = "https://telegram.me/ssss3456"}}})
	end
